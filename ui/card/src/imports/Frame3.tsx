import svgPaths from "./svg-5txpsgy8ok";

function Group1() {
  return (
    <div className="absolute contents left-[39.5px] top-[520px]">
      <div className="absolute bg-[#1f1f1f] border-[#2e2e2e] border-[5px] border-solid h-[85px] left-[39.5px] rounded-[32px] top-[520px] w-[481px]" />
      ...
      <p className="absolute font-['Helvetica:Regular',sans-serif] leading-[normal] left-[186px] not-italic opacity-[0.63] text-[32px] text-nowrap text-white top-[544px] tracking-[-1.28px]">Refer Website</p>
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute inset-[16.77%_82.68%_76.79%_8.21%]" data-name="Group">
...
function Icon() {
  return (
    <div className="absolute contents left-[40px] top-[97px]" data-name="icon">
      <div className="absolute bg-white left-[40px] rounded-[20px] shadow-[0px_4px_11px_1px_rgba(0,0,0,0.21)] size-[64px] top-[97px]" />
      <Group />
    </div>
  );
}
...
function Group2() {
  return (
    <div className="absolute contents left-[438px] top-[97px]">
      <div className="absolute bg-[#070707] h-[35.556px] left-[438px] rounded-[100px] top-[97px] w-[64px]" />
      <div className="absolute bg-white h-[44.444px] left-[438px] rounded-bl-[18px] rounded-br-[18px] top-[116.56px] w-[64px]" />
    </div>
  );
}
...
function Date() {
  return (
    <div className="absolute contents left-[438px] top-[97px]" data-name="date">
      <Group2 />
      <p className="absolute font-['Helvetica:Regular',sans-serif] leading-[normal] left-[459px] not-italic text-[11px] text-nowrap text-white top-[102px] tracking-[0.22px]">JAN</p>
      <p className="absolute font-['Helvetica:Regular',sans-serif] leading-[normal] left-[457px] not-italic text-[24px] text-black text-nowrap top-[125px] tracking-[-0.96px]">20</p>
    </div>
  );
}
...
export default function Frame() {
  return (
    <div className="bg-white relative rounded-[57px] shadow-[0px_24px_46px_9px_rgba(0,0,0,0.25)] size-full">
      <Group1 />
